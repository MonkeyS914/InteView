...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BStreamFileToolkit.h,v 1.167 2009-01-20 02:06:46 covey Exp $
//
...
*/
class Internal_Data_Accumulator {
    private:
...
class  Recorded_Instance : public BControlledMemoryObject {
    public:
