...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BAscii.cpp,v 1.74 2008-11-20 21:29:42 jason Exp $
//
											  ...
											  float * rFloats, unsigned int n) alter
{
	...
	auto		char			err_msg[MVO_BUFFER_SIZE];
...
TK_Status TK_Header::WriteAscii (BStreamFileToolkit & tk) alter {
    ...
    auto        TK_Status       status = TK_Normal;
	auto        char            root_node[MVO_BUFFER_SIZE];
...
TK_Status TK_Text::WriteAscii (BStreamFileToolkit & tk) alter {
    ...
    auto        TK_Status			status = TK_Normal;
	auto		unsigned char		options = m_options;
        ...
        case 11: {
            if ((options & TKO_Text_Option_Character_Attributes) != 0) {
				while (m_progress < m_count) {
					auto	TK_Character_Attribute *	ca = &m_character_attributes[m_progress];
					...
					switch (m_substage) {
						...
						case 1: {
							...
							if ((ca->mask & TKO_Character_Name) != 0) {
								auto	int				len = (int)strlen (ca->name);
...
//                auto        int     total = m_size[0] * m_size[1] * TK_Image_Bytes_Per_Pixel[(int)m_format];
//				
    ...
    switch (m_stage) {
        ...
        case 4: {
            ...
            if ((m_mask & TKO_Geo_Extended2) != 0) {
                auto    unsigned char       byte = (unsigned char)((m_mask>>24) & 0x000000FF);
    ...
    switch (m_stage) {
        ...
        case 26: {
            if ((emask & m_value[1] & TKO_Rendo_Simple_Shadow) != 0) {
                ...
                switch (m_progress) {
                    case 0: {
                        auto        unsigned char       byte = (unsigned char)smask;
						PutTab t(&tk);
                    ...
                    case 1: {
                        ...
                        if ((smask & TKO_Simple_Shadow_Extended) != 0) {
                            auto            unsigned char       byte = (unsigned char)(smask >> 8);
...
TK_Status TK_Visibility::WriteAscii (BStreamFileToolkit & tk) alter {
    ...
    switch (m_stage) {
        ...
        case 5: {
			PutTab t(&tk);
            if ((m_mask & TKO_Geo_Extended2) != 0) {
                auto    int      byte = (unsigned short) ((m_mask>>24) & 0x000000FF);
        ...
        case 6: {
			PutTab t(&tk);
            if ((m_mask & TKO_Geo_Extended2) != 0) {
                auto   int     byte = (unsigned short) ((m_value>>24) & 0x000000FF);
...
TK_Status TK_Text_Font::WriteAscii (BStreamFileToolkit & tk) alter {
    ...
    switch (m_stage) {
        ...
        case 1: {
            auto        unsigned char       byte = (unsigned char)(mask & 0x000000FF);
			PutTab t(&tk);
            if ((status = PutAsciiMask (tk,"Mask", byte)) != TK_Normal)
                return status;
            m_stage++;
        ...
        case 3: {
            ...
            if ((mask & TKO_Font_Extended) != 0) {
                auto    unsigned char       byte = (unsigned char)((mask>>8) & 0x000000FF);
        ...
        case 5: {
            ...
            if ((mask & TKO_Font_Extended2) != 0) {
                auto    unsigned short      word = (unsigned short)((mask>>16) & 0x0000FFFF);
        ...
        case 6: {
			PutTab t(&tk);
            if ((mask & TKO_Font_Extended2) != 0) {
                auto    unsigned short      word = (unsigned short)((m_value>>16) & 0x0000FFFF);
