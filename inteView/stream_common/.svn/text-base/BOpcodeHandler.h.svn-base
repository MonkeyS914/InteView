...
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BOpcodeHandler.h,v 1.449.2.5 2009-07-01 21:18:05 evan Exp $
...
/*! 
	...
	handler.
*/
class  TK_Default : public BBaseOpcodeHandler {
...
*/
class  TK_Unavailable : public BBaseOpcodeHandler {
	public:
		/*! constructor */
...
*/
class  TK_Compression : public BBaseOpcodeHandler {
	public:
		/*! constructor */
...
*/
class  TK_Open_Segment : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Close_Segment : public BBaseOpcodeHandler {
	public:
		/*! constructor */
...
*/
class  TK_Reopen_Segment : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Reference : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Delete_Object : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_LOD : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Geometry_Attributes : public BBaseOpcodeHandler {
	protected:
...
/*!  
	...
	alphabetic sorting.
*/
class  TK_Renumber : public BBaseOpcodeHandler {
	protected:
		ID_Key          m_key; //!< for internal use only
...
/*!  
	...
	See the Programming Guide for more detailed information.
*/
class  TK_Tag : public BBaseOpcodeHandler {
	protected:
...
class  TK_Dictionary : public BBaseOpcodeHandler {
	protected:
...
/*!  
	...
	The HOOPS/3dGS scene-graph segments can have a 'named' color (i.e. "faces = red, lines = blue")
*/
class  TK_Color_RGB : public BBaseOpcodeHandler {
	protected:
		int             m_mask;		//!< internal use	
...
*/
class  TK_Color_By_Value : public BBaseOpcodeHandler {
	protected:
		int             m_mask;			//!< internal use
...
*/
class  TK_Color_By_Index : public BBaseOpcodeHandler {
	protected:
		int             m_mask;		//!< internal use
		int             m_index;	//!< internal use
...
*/
class  TK_Color_By_FIndex : public BBaseOpcodeHandler {
	protected:
		int             m_mask;		//!< internal use
		float           m_index;	//!< internal use
...
*/
class  TK_Callback : public BBaseOpcodeHandler {
	protected:
...
#define TKO_Rendo_Extended					0x80000000   
	...
	TKO_Rendo_Vertex_Decimation			= 0x20000000,  //!< refer to ::HC_Set_Rendering_Options for description	// placeholder for 18.00
...
#if 0
class  TK_Radiosity_RayTrace_Options : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Rendering_Options : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Visibility : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Matrix : public BBaseOpcodeHandler {
	protected:
		float           m_matrix[16];  //!< internal use
...
*/
class  TK_Enumerated : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Linear_Pattern : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Streaming : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Unicode_Options : public BBaseOpcodeHandler {
	protected:
		int                     m_length;       /*!< Length of text string */
...
class  TK_User_Index : public BBaseOpcodeHandler {
	...
	public:
		...
		long const *    GetValues () const          { return m_values;                      }
		/*! Returns the value array buffer, which may be modified directly */
		long alter *    GetValues () alter          { return m_values;                      }
};
...
*/
class  TK_User_Value : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Line : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Polypoint : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_NURBS_Curve : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Area_Light : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Spot_Light : public BBaseOpcodeHandler {
	protected:
...
//	grid spacing.
//*/
class  TK_Grid : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Text : public BBaseOpcodeHandler {
	protected:
...
*/
//class 2 TK_Thumbnail : public BBaseOpcodeHandler {
//	protected:
//		char *                  m_bytes;        /*!< internal use; Image data */
//		int                     m_size[2];      /*!< internal use; Width & Height */
//		unsigned char           m_format;       /*!< internal use; Format of data */
...
*/
class  TK_Glyph_Definition : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_Line_Style : public BBaseOpcodeHandler {
	protected:
...
class  TK_User_Data : public BBaseOpcodeHandler {
	...
	public:
		...
		*/
		...
		/*! Returns the address of the data buffer */
		char const *    GetUserData () const                                { return m_data;            }
		/*! Returns the address of the data buffer, which may be modified directly */
		char alter *    GetUserData () alter                                { return m_data;            }
		/*! Returns the size of the data buffer */
		int             GetSize () const                                    { return m_size;            }
...
*/
class  TK_XML : public BBaseOpcodeHandler {
	protected:
...
*/
class  TK_External_Reference : public BBaseOpcodeHandler {
	protected:
		int             m_length;       /*!< internal use; Length of text string */
		int             m_allocated;    /*!< internal use; Size of allocated string buffer */
		char *          m_string;       /*!< internal use; Text string */
...
/*! 
	...
	current data stream (similar to an "include" directive in a programming language).
*/
class  TK_External_Reference_Unicode : public BBaseOpcodeHandler {
	protected:
		int             m_length;       /*!< internal use; Length of text string */
		int             m_allocated;    /*!< internal use; Size of allocated string buffer */
