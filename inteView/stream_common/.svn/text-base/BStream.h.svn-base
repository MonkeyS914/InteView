...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BStream.h,v 1.221.2.5 2009-06-29 23:50:33 ann Exp $
//
...
/*! 
    \def 2 resolves to whatever special keywords are required to make a function or class
...
/*!
	\def  Under most circumstances, simply resolves to the same thing as 2. 
*/
//#ifdef TEST_RIG_1
//    #define 
//#else
...
*/
#define TK_File_Format_Version       1715   // 17.15
...
//		//------------------------------------------------------------------------------------------
//		//	1715,	//			vertex displacement (Note, 1770 in dev code)
//			1710,	//			ignore subsegment locks, transparency depth writing
...
//    };
//#else
//    extern  int TK_File_Format_History[];
//#endif
...
/*! \fn TK_Status  TK_Read_Stream_File  (char const * filename, BStreamFileToolkit * tk)
...
TK_Status  TK_Read_Stream_File  (__wchar_t const * filename, BStreamFileToolkit * tk);
#ifdef _MSC_VER
TK_Status  TK_Read_Stream_File  (unsigned short const * filename, BStreamFileToolkit * tk);
#endif

/*! wide character variant of the standard version of TK_Read_Stream_File */
TK_Status  TK_Read_Stream_File  (__wchar_t const * filename, int flags = 0);
#ifdef _MSC_VER
TK_Status  TK_Read_Stream_File  (unsigned short const * filename, int flags = 0);
#endif
