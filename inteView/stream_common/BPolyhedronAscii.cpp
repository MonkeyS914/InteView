...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BPolyhedronAscii.cpp,v 1.46 2008-11-19 20:43:39 jason Exp $
//
...
TK_Status TK_Polyhedron::write_collection_ascii (BStreamFileToolkit & tk, bool write_tag, int variant) alter {
	...
	auto        TK_Status       status = TK_Normal;
	auto        TK_Terminator   terminate(TKE_Termination, false);
...
TK_Status TK_Polyhedron::read_collection_ascii (BStreamFileToolkit & tk) alter {
	...
	auto	   int				word_count = 0;
	auto       char				temp_opcode[512];	
//	auto       unsigned int		sequence;
	auto       unsigned char	opcode_word = '\0';
	auto	   int				i;
