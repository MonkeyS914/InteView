...
H_UTF32::iterator H_UTF32::end() const {return iterator(m_utf32 + length() +1);}
...
H_UTF16::iterator H_UTF16::end() const {return iterator(m_utf16 + length() +1);}
...
H_UTF8::iterator H_UTF8::end() const {return iterator(m_utf8 + length() +1);}
...
H_URI::iterator H_URI::end() const {return iterator(m_uri + length() +1);}
